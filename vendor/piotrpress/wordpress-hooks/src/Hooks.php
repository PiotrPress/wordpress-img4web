...
namespace Img4Web\Vendor\PiotrPress\WordPress;

use Img4Web\Vendor\PiotrPress\WordPress\Hooks\Filter as Hook;
use Img4Web\Vendor\PiotrPress\CacheInterface;
use Img4Web\Vendor\PiotrPress\Cacher;
